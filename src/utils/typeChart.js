// Tabela completa de efetividade de tipos (atacante -> defensor)
const typeChart = {
...
export function getWeaknessesAndResistances(types) {
  const effectiveness = {}
  ...
  allTypes.forEach(attackType => {
    ...
    if (multiplier !== 1) effectiveness[attackType] = multiplier
  })
